...
func TestTextInputState_GetSelectionBounds_ClampsToContentLength(t *testing.T) {
...
func TestTextInputState_Insert_ClearsSelectionAnchor(t *testing.T) {
